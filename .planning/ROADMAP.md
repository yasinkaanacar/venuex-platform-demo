...
- [x] **Phase 1: Foundation** - analytics.ts helper + validated pageview strategy (completed 2026-04-03)
...
Plans:
- [x] 01-01-PLAN.md — Create analytics.ts helper with typed events + validate pageview strategy
