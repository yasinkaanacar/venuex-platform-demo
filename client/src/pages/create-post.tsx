    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        <div className="max-w-4xl mx-auto space-y-6">
                  ...
                  {mockStoreSets
                    ...
                    .map((set) => (
                      <button
                        ...
                        className={`p-3 rounded-lg border text-left transition-all flex items-center gap-2 ${selectedStoreSets.includes(set.id)
                            ? 'bg-blue-600 border-blue-600 text-white'
                            : 'bg-white border-gray-200 hover:border-blue-300'
                          }`}
                      >
                        <div className={`w-5 h-5 rounded border flex items-center justify-center ${selectedStoreSets.includes(set.id)
                  ...
                  {mockLocations
                    ...
                    .map((loc) => (
                      <button
                        ...
                        className={`p-3 rounded-lg border text-left transition-all flex items-center gap-2 ${selectedLocations.includes(loc.id)
                            ? 'bg-blue-600 border-blue-600 text-white'
                            : 'bg-white border-gray-200 hover:border-blue-300'
                          }`}
                      >
                        <div className={`w-5 h-5 rounded border flex items-center justify-center ${selectedLocations.includes(loc.id)
                            ? 'bg-white border-white'
                            : 'border-gray-300'
                          }`}>
          ...
          <div className={`p-6 rounded-xl border transition-all ${apple.enabled ? 'bg-white border-blue-200 shadow-sm' : 'bg-gray-50 border-gray-200 opacity-70'}`}>
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-semibold flex items-center gap-2 text-gray-700">
          ...
          <div className="flex justify-end pt-2">
            <button
              className={`px-8 py-3 font-semibold rounded-lg transition-colors shadow-sm flex items-center gap-2 ${google.enabled || apple.enabled
