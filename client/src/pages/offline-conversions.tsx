  ...
  return (
    <div className="min-h-full bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <Card className="mb-8 bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50 border-2 border-gray-200/50 dark:border-gray-700/50 shadow-xl">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Revenue performance across digital and physical channels
                </p>
              </div>
              <div className="flex items-center gap-3">
                <div className="text-center">
                  <p className="text-xs text-gray-500 dark:text-gray-400">Total Revenue</p>
                  <p className="text-lg font-bold text-green-600">{formatCurrency(234800)}</p>
                </div>
                <div className="text-center">
                  <p className="text-xs text-gray-500 dark:text-gray-400">Overall ROAS</p>
                  <p className="text-lg font-bold text-indigo-600">4.8:1</p>
                </div>
                <div className="text-center">
                  <p className="text-xs text-gray-500 dark:text-gray-400">Online ROAS</p>
                  <p className="text-lg font-bold text-cyan-600">3.2:1</p>
                </div>
                <div className="text-center">
                  <p className="text-xs text-gray-500 dark:text-gray-400">Offline ROAS</p>
                  <p className="text-lg font-bold text-teal-600">5.4:1</p>
                </div>
                <div className="text-center">
          ...
          <CardContent className="pt-0">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-900/20 dark:to-green-900/20 rounded-lg p-6">
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-4 flex items-center space-x-2">
                  <Users className="w-5 h-5 text-blue-600" />
                  <span>Digital-to-Physical Journey</span>
                </h3>
                
                <div className="grid grid-cols-5 gap-4 items-center">
                  {/* Stage 1: Digital Impressions */}
                  <div className="text-center">
                    <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-2">
                      <span className="text-white font-bold text-sm">1.2M</span>
                    </div>
                    <div className="text-xs font-medium text-gray-700 dark:text-gray-300">Digital Impressions</div>
                    <div className="text-xs text-gray-500">Ad Views</div>
                  </div>
                  ...
                  <div className="text-center">
                    <div className="w-14 h-14 bg-cyan-500 rounded-full flex items-center justify-center mx-auto mb-2">
                      <span className="text-white font-bold text-sm">45K</span>
                    </div>
                    <div className="text-xs font-medium text-gray-700 dark:text-gray-300">Website Visits</div>
                    <div className="text-xs text-gray-500">Click Rate: 3.8%</div>
                  </div>
                  ...
                  {/* Stage 3: Store Visits */}
                  <div className="text-center">
                    <div className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-2">
                      <span className="text-white font-bold text-sm">3.2K</span>
                    </div>
                    <div className="text-xs font-medium text-gray-700 dark:text-gray-300">Store Visits</div>
                    <div className="text-xs text-gray-500">Conversion: 7.1%</div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 text-center">
                  <div className="flex items-center justify-center gap-1 mb-2">
                    ...
                    <span className="text-sm font-medium text-blue-700 dark:text-blue-300">Online Sales</span>
                  </div>
                  <p className="text-2xl font-bold text-blue-600">{formatCurrency(89200)}</p>
                  <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Direct purchases</p>
                </div>
                
                <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 text-center">
                  <div className="flex items-center justify-center gap-1 mb-2">
                    <MapPin className="w-4 h-4 text-green-600" />
                    <span className="text-sm font-medium text-green-700 dark:text-green-300">Offline Sales</span>
                  </div>
                  <p className="text-2xl font-bold text-green-600">{formatCurrency(145600)}</p>
                  <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">In-store purchases</p>
                </div>
                
                <div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4 text-center">
                  <div className="flex items-center justify-center gap-1 mb-2">
                    <DollarSign className="w-4 h-4 text-orange-600" />
                    <span className="text-sm font-medium text-orange-700 dark:text-orange-300">Total Ad Spend</span>
                  </div>
                  <p className="text-2xl font-bold text-orange-600">{formatCurrency(48900)}</p>
                  <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">Investment cost</p>
                </div>
              </div>
              ...
              <div className="border-t pt-6">
                <h4 className="font-semibold text-gray-700 dark:text-gray-300 mb-4 flex items-center space-x-2">
                  <Target className="w-4 h-4" />
                  <span>Attribution Impact Analysis</span>
                </h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div>
                        <div className="font-medium text-gray-900 dark:text-white text-sm">Digital Influence Rate</div>
                        <div className="text-xs text-gray-500">Offline sales attributed to online touchpoints</div>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div>
                        <div className="font-medium text-gray-900 dark:text-white text-sm">Cross-Channel Synergy</div>
                        <div className="text-xs text-gray-500">Combined performance boost</div>
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div>
                        <div className="font-medium text-gray-900 dark:text-white text-sm">Avg Customer Journey</div>
                        <div className="text-xs text-gray-500">Days from first click to purchase</div>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div>
                        <div className="font-medium text-gray-900 dark:text-white text-sm">Store Visit Rate</div>
                        <div className="text-xs text-gray-500">Digital visitors who visit physical stores</div>
                      </div>
                      <div className="text-lg font-bold text-teal-600">7.1%</div>
                    </div>
                  </div>
                </div>
              </div>
