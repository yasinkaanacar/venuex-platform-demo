              ...
              >
                ...
                {isExpanded && (
                  <div className="px-4 pb-4 bg-white">
                    {/* Context Tags */}
                    <div className="flex flex-wrap items-center justify-center text-center gap-2 mb-4 pb-4 border-b border-gray-100">
                      {rec.campaign && (
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button variant="outline" className="text-sm h-10 !border-2 !border-red-500 !text-red-500 hover:!bg-red-500 hover:!text-white" data-testid="button-dismiss">
