...
export const themeAnalysisData: ThemeAnalysisItem[] = [
  { name: 'Lezzet', reviews: 156, avgRating: 4.5, venueXScore: 92 },
  { name: 'Personel Hizmeti', reviews: 142, avgRating: 4.3, venueXScore: 87 },
  { name: 'Temizlik', reviews: 128, avgRating: 4.4, venueXScore: 89 },
  { name: 'Atmosfer', reviews: 115, avgRating: 4.2, venueXScore: 84 },
  { name: 'Hızlı Servis', reviews: 98, avgRating: 3.9, venueXScore: 76 },
  { name: 'Fiyat', reviews: 89, avgRating: 3.2, venueXScore: 58 },
  { name: 'Bekleme Süresi', reviews: 76, avgRating: 3.0, venueXScore: 52 },
  { name: 'Otopark', reviews: 64, avgRating: 2.8, venueXScore: 45 },
  { name: 'Gürültü Seviyesi', reviews: 52, avgRating: 3.1, venueXScore: 54 },
  { name: 'Porsiyon Büyüklüğü', reviews: 43, avgRating: 3.5, venueXScore: 62 },
];
...
export const reviewLocationsData: ReviewLocationData[] = [
  { code: "STR001", name: "Bağdat Caddesi", city: "Istanbul", sublocation: "Kadıköy", reviews: 542, rating: 4.7, replyRate: 85, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Personel Hizmeti", topNegative: "Otopark" },
  { code: "STR002", name: "Kanyon AVM", city: "Istanbul", sublocation: "Levent", reviews: 489, rating: 4.6, replyRate: 78, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Ürün Kalitesi", topNegative: "Bekleme Süresi" },
  { code: "STR003", name: "İstinyePark", city: "Istanbul", sublocation: "Sarıyer", reviews: 456, rating: 4.8, replyRate: 92, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Mağaza Tasarımı", topNegative: "Fiyat" },
  { code: "STR004", name: "Zorlu Center", city: "Istanbul", sublocation: "Beşiktaş", reviews: 423, rating: 4.6, replyRate: 81, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Personel Hizmeti", topNegative: "Kalabalık" },
  { code: "STR005", name: "Nişantaşı", city: "Istanbul", sublocation: "Şişli", reviews: 398, rating: 4.7, replyRate: 88, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Moda Seçkisi", topNegative: "Pahalı" },
  { code: "STR006", name: "Akasya AVM", city: "Istanbul", sublocation: "Acıbadem", reviews: 376, rating: 4.6, replyRate: 79, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Temizlik", topNegative: "Uzun Kuyruklar" },
  { code: "STR007", name: "Cevahir AVM", city: "Istanbul", sublocation: "Şişli", reviews: 365, rating: 4.7, replyRate: 83, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Çeşitlilik", topNegative: "Yönlendirme" },
...
export const locationContextData: Record<string, LocationContext> = {
  "Bağdat Caddesi": { overallRating: 4.2, totalReviews: 287, topNegativeTheme: "Otopark Sorunları" },
  "Kanyon AVM": { overallRating: 3.8, totalReviews: 412, topNegativeTheme: "Uzun Bekleme Süreleri" },
  "İstinyePark": { overallRating: 4.1, totalReviews: 356, topNegativeTheme: "Personel Tutumu" },
  "Zorlu Center": { overallRating: 3.9, totalReviews: 298, topNegativeTheme: "Ürün Bulunabilirliği" },
  "Nişantaşı": { overallRating: 4.5, totalReviews: 189, topNegativeTheme: "Fiyatlandırma" },
  "Akasya AVM": { overallRating: 3.7, totalReviews: 223, topNegativeTheme: "Mağaza Düzeni" },
  "Cevahir AVM": { overallRating: 3.6, totalReviews: 445, topNegativeTheme: "Kalabalık Yönetimi" },
  "Emaar AVM": { overallRating: 4.0, totalReviews: 312, topNegativeTheme: "Ürün Kalitesi" },
  "Ankamall": { overallRating: 3.5, totalReviews: 156, topNegativeTheme: "Personel Tutumu" },
  "Forum İzmir": { overallRating: 3.9, totalReviews: 278, topNegativeTheme: "Teslimat Süreleri" },
  "Kent Meydanı": { overallRating: 3.8, totalReviews: 167, topNegativeTheme: "Ürün Seçimi" },
  "Marina Mall": { overallRating: 3.4, totalReviews: 134, topNegativeTheme: "Servis Hızı" },
  "Optimum": { overallRating: 4.2, totalReviews: 389, topNegativeTheme: "Otopark Sorunları" },
  "Forum Mersin": { overallRating: 3.7, totalReviews: 145, topNegativeTheme: "Personel Eğitimi" },
  "Sanko Park": { overallRating: 3.9, totalReviews: 198, topNegativeTheme: "Ürün Bulunabilirliği" },
  "Kulesite": { overallRating: 3.3, totalReviews: 112, topNegativeTheme: "Erişilebilirlik" },
  "Espark": { overallRating: 3.8, totalReviews: 156, topNegativeTheme: "Bakım" },
  "Park AVM": { overallRating: 4.0, totalReviews: 201, topNegativeTheme: "Otopark Ücretleri" },
  "Forum Trabzon": { overallRating: 3.6, totalReviews: 178, topNegativeTheme: "Hava Koruması" },
  "Piazza Samsun": { overallRating: 3.9, totalReviews: 189, topNegativeTheme: "Yemek Alanı" },
};

export const productContextData: Record<string, ProductContext> = {
  "Running Shoes": { overallRating: 4.3, topNegativeTheme: "Beden Sorunları", sku: "RS-001" },
  "Winter Coat": { overallRating: 3.8, topNegativeTheme: "Fermuar Kalitesi", sku: "WC-045" },
  "Coffee Maker": { overallRating: 3.2, topNegativeTheme: "Yapı Kalitesi", sku: "CM-123" },
  "Wireless Headphones": { overallRating: 4.1, topNegativeTheme: "Bağlantı Sorunları", sku: "WH-078" },
  "Laptop Bag": { overallRating: 4.4, topNegativeTheme: "Kayış Dayanıklılığı", sku: "LB-256" },
  "Smartphone Case": { overallRating: 3.9, topNegativeTheme: "Malzeme Kalitesi", sku: "SC-189" },
  "Yoga Mat": { overallRating: 3.6, topNegativeTheme: "Kalınlık", sku: "YM-067" },
  "Kitchen Knife": { overallRating: 4.2, topNegativeTheme: "Tutma Konforu", sku: "KK-234" },
  "Desk Lamp": { overallRating: 3.7, topNegativeTheme: "Parlaklık Kontrolü", sku: "DL-145" },
  "Bluetooth Speaker": { overallRating: 4.0, topNegativeTheme: "Pil Ömrü", sku: "BS-098" },
};

// ── Reply Templates ─────────────────────────────────────────────────────────

export const replyTemplates: ReplyTemplate[] = [
  { id: 1, name: "Olumlu Yanıt - 5 Yıldız", preview: "Harika geri bildiriminiz için teşekkür ederiz..." },
  { id: 2, name: "Olumsuz Yanıt - Personel Sorunu", preview: "Personel sorunu nedeniyle içtenlikle özür dileriz..." },
];
