...
export const reviewLocationsData: ReviewLocationData[] = [
  { code: "BOY001", name: "Bağdat Caddesi", city: "Istanbul", sublocation: "Kadıköy", reviews: 542, rating: 4.7, replyRate: 85, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Staff Service", topNegative: "Parking" },
  { code: "BOY002", name: "Kanyon AVM", city: "Istanbul", sublocation: "Levent", reviews: 489, rating: 4.6, replyRate: 78, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Product Quality", topNegative: "Wait Time" },
  { code: "BOY003", name: "İstinyePark", city: "Istanbul", sublocation: "Sarıyer", reviews: 456, rating: 4.8, replyRate: 92, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Store Design", topNegative: "Price" },
  { code: "BOY004", name: "Zorlu Center", city: "Istanbul", sublocation: "Beşiktaş", reviews: 423, rating: 4.6, replyRate: 81, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Staff Service", topNegative: "Crowded" },
  { code: "BOY005", name: "Nişantaşı", city: "Istanbul", sublocation: "Şişli", reviews: 398, rating: 4.7, replyRate: 88, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Fashion Selection", topNegative: "Expensive" },
  { code: "BOY006", name: "Akasya AVM", city: "Istanbul", sublocation: "Acıbadem", reviews: 376, rating: 4.6, replyRate: 79, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Cleanliness", topNegative: "Long Queues" },
  { code: "BOY007", name: "Cevahir AVM", city: "Istanbul", sublocation: "Şişli", reviews: 365, rating: 4.7, replyRate: 83, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Variety", topNegative: "Navigation" },
  { code: "BOY008", name: "Emaar AVM", city: "Istanbul", sublocation: "Ümraniye", reviews: 342, rating: 4.6, replyRate: 76, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Modern Design", topNegative: "Accessibility" },
  { code: "BOY009", name: "Ankamall", city: "Ankara", sublocation: "Çankaya", reviews: 325, rating: 4.6, replyRate: 74, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Staff Helpfulness", topNegative: "Limited Stock" },
  { code: "BOY010", name: "Forum İzmir", city: "Izmir", sublocation: "Bornova", reviews: 312, rating: 4.5, replyRate: 71, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Location", topNegative: "Parking Fee" },
  { code: "BOY011", name: "Kent Meydanı", city: "Bursa", sublocation: "Osmangazi", reviews: 298, rating: 4.5, replyRate: 68, sentiment: ReviewSentimentEnum.NEUTRAL, topPositive: "Product Range", topNegative: "Service Speed" },
  { code: "BOY012", name: "Migros AVM", city: "Antalya", sublocation: "Konyaaltı", reviews: 287, rating: 4.5, replyRate: 72, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Beach Proximity", topNegative: "Tourist Prices" },
  { code: "BOY013", name: "Optimum", city: "Adana", sublocation: "Seyhan", reviews: 276, rating: 4.5, replyRate: 67, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Air Conditioning", topNegative: "Noise Level" },
  { code: "BOY014", name: "Forum Mersin", city: "Mersin", sublocation: "Akdeniz", reviews: 265, rating: 4.6, replyRate: 75, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Sea View", topNegative: "Traffic Access" },
  { code: "BOY015", name: "Sanko Park", city: "Gaziantep", sublocation: "Şahinbey", reviews: 254, rating: 4.5, replyRate: 69, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Local Culture", topNegative: "Language Barrier" },
  { code: "BOY016", name: "Kulesite", city: "Konya", sublocation: "Meram", reviews: 243, rating: 4.4, replyRate: 63, sentiment: ReviewSentimentEnum.NEUTRAL, topPositive: "Traditional Feel", topNegative: "Old Building" },
  { code: "BOY017", name: "Espark", city: "Eskişehir", sublocation: "Tepebaşı", reviews: 232, rating: 4.5, replyRate: 66, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Student Friendly", topNegative: "Limited Premium" },
  { code: "BOY018", name: "Park AVM", city: "Kayseri", sublocation: "Kocasinan", reviews: 221, rating: 4.4, replyRate: 61, sentiment: ReviewSentimentEnum.NEUTRAL, topPositive: "Central Location", topNegative: "Outdated Style" },
  { code: "BOY019", name: "Forum Trabzon", city: "Trabzon", sublocation: "Ortahisar", reviews: 210, rating: 4.5, replyRate: 64, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Regional Products", topNegative: "Weather Dependent" },
  { code: "BOY020", name: "Piazza Samsun", city: "Samsun", sublocation: "Atakum", reviews: 198, rating: 4.4, replyRate: 59, sentiment: ReviewSentimentEnum.NEUTRAL, topPositive: "Coastal Location", topNegative: "Seasonal Crowds" },
  { code: "BOY021", name: "Forum Erzurum", city: "Erzurum", sublocation: "Yakutiye", reviews: 189, rating: 4.1, replyRate: 58, sentiment: ReviewSentimentEnum.NEUTRAL, topPositive: "Winter Sports", topNegative: "Cold Weather" },
  { code: "BOY022", name: "Arasta Park", city: "Malatya", sublocation: "Battalgazi", reviews: 167, rating: 3.8, replyRate: 52, sentiment: ReviewSentimentEnum.NEGATIVE, topPositive: "Apricot Season", topNegative: "Limited Options" },
  { code: "BOY023", name: "100. Yıl AVM", city: "Van", sublocation: "İpekyolu", reviews: 156, rating: 3.3, replyRate: 39, sentiment: ReviewSentimentEnum.NEGATIVE, topPositive: "Lake View", topNegative: "Remote Location" },
  { code: "BOY024", name: "Piazza Şanlıurfa", city: "Şanlıurfa", sublocation: "Haliliye", reviews: 145, rating: 4.0, replyRate: 55, sentiment: ReviewSentimentEnum.NEUTRAL, topPositive: "Historical Context", topNegative: "Hot Climate" },
  { code: "BOY025", name: "Forum Diyarbakır", city: "Diyarbakır", sublocation: "Bağlar", reviews: 134, rating: 3.9, replyRate: 48, sentiment: ReviewSentimentEnum.NEUTRAL, topPositive: "Cultural Heritage", topNegative: "Security Concerns" },
  { code: "BOY026", name: "Kentpark", city: "Denizli", sublocation: "Pamukkale", reviews: 128, rating: 4.4, replyRate: 71, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Thermal Tourism", topNegative: "Tourist Season" },
  { code: "BOY027", name: "Forum Çamlık", city: "Manisa", sublocation: "Yunusemre", reviews: 121, rating: 4.2, replyRate: 62, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Grape Harvest", topNegative: "Agricultural Area" },
  { code: "BOY028", name: "Novada Söke", city: "Aydın", sublocation: "Söke", reviews: 115, rating: 4.0, replyRate: 57, sentiment: ReviewSentimentEnum.NEUTRAL, topPositive: "Cotton Fields", topNegative: "Rural Setting" },
  { code: "BOY029", name: "Mavera AVM", city: "Muğla", sublocation: "Bodrum", reviews: 108, rating: 4.3, replyRate: 68, sentiment: ReviewSentimentEnum.POSITIVE, topPositive: "Resort Atmosphere", topNegative: "Seasonal Business" },
  { code: "BOY030", name: "Akçaabat Çarşı", city: "Trabzon", sublocation: "Akçaabat", reviews: 98, rating: 4.1, replyRate: 54, sentiment: ReviewSentimentEnum.NEUTRAL, topPositive: "Local Cuisine", topNegative: "Transportation" },
];
