...
export const mockLocations: LocationData[] = [
    // 1. HAPPY PATH (Sorunsuz Mağaza)
    {
        ...
        city: 'İstanbul',
        district: 'Kadıköy',
        name: 'Acme Home - İstanbul - Kadıköy',
        address: 'Caferağa Mah. Moda Cad. No:12',
        phone: '+90 216 555 0001',
        email: 'kadikoy@acmehome.com',
        imageUrl: 'https://example.com/img1.jpg',
        website: 'https://acmehome.com',
    ...
    // 4. VALIDATION ERROR (Format Hatası - Meta)
    {
        ...
        city: 'Antalya',
        district: 'Muratpaşa',
        name: 'Acme Home - Antalya - Muratpaşa',
    ...
    // 5. RATE LIMIT (Trafik - Apple)
    {
        ...
        city: 'Muğla',
        district: 'Bodrum',
        name: 'Acme Home - Muğla - Bodrum',
        address: 'Neyzen Tevfik Cad.',
        phone: '+90 252 000 0000',
        email: 'bodrum@acmehome.com',
    ...
    // 6. GOOGLE SUSPENDED (Askıya Alındı)
    {
        ...
        city: 'Bursa',
        district: 'Osmangazi',
        name: 'Acme Home - Bursa - Osmangazi',
        address: 'Heykel Mah. Atatürk Cad. No:10',
        phone: '+90 224 555 0008',
        email: 'osmangazi@acmehome.com',
    ...
    // 9. APPLE PENDING REVIEW (İnceleme Bekliyor)
    {
        ...
        city: 'Gaziantep',
        district: 'Şahinbey',
        name: 'Acme Home - Gaziantep - Şahinbey',
        address: 'Şahinbey Mah. Gaziler Cad. No:88',
        phone: '+90 342 555 0011',
        email: 'sahinbey@acmehome.com',
    ...
    // 10. META DISCONNECTED (Yetki Yok)
    {
        ...
        city: 'Trabzon',
        district: 'Ortahisar',
        name: 'Acme Home - Trabzon - Ortahisar',
        address: 'Ortahisar Mah. Maraş Cad. No:22',
        phone: '+90 462 555 0012',
        email: 'ortahisar@acmehome.com',
...
export const mockLocationConflicts: LocationConflict[] = [
    ...
    // 2. Only in Google — unmatched listing not in VenueX
    {
        ...
        googleLocation: {
            ...
            name: 'Acme Home - İstanbul - Bağcılar',
    ...
    // 3. Data mismatch — both exist but data differs
    {
        ...
        googleLocation: {
            ...
            website: 'https://acmehome.com.tr',
        },
        mismatchFields: [
            { field: 'phone', vxValue: '+90 216 555 0001', googleValue: '+90 216 555 9999' },
            { field: 'website', vxValue: 'https://acmehome.com', googleValue: 'https://acmehome.com.tr' },
        ],
    },
    {
        id: 'lc-006',
        ...
        googleLocation: {
            ...
            name: 'Acme Home - Ankara - Kızılay',
            address: 'Kızılay Mah. Atatürk Blv. No:45/B, Çankaya / Ankara',
            phone: '+90 312 555 0076',
        },
        mismatchFields: [
            { field: 'name', vxValue: 'Acme Home - Ankara - Çankaya', googleValue: 'Acme Home - Ankara - Kızılay' },
