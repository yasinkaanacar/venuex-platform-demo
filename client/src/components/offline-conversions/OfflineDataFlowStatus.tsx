...
export default function OfflineDataFlowStatus() {
    ...
    return (
        <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-5">
            <h3 className="text-sm font-semibold text-gray-700 mb-4">Veri Bağlantı Durumu</h3>
            ...
            <div className="flex items-center justify-between bg-gray-50 rounded-lg p-4 overflow-hidden">
                ...
                <div className="flex items-center gap-3 flex-shrink-0 z-10">
                    ...
                    <div>
                        <p className="text-sm font-medium text-gray-900">POS / Mağaza Verisi</p>
                        <p className="text-xs text-gray-500">5 dk önce senkronize oldu</p>
                    </div>
                </div>
            ...
            <div className="mt-5 pt-4 border-t border-gray-100">
                ...
                <div className="grid grid-cols-5 gap-4">
                    ...
                    <div>
                        <p className="text-xs text-gray-500 mb-1">Dönüşüm Sayısı</p>
                        <p className="text-sm font-medium text-gray-900">154 Adet</p>
                    </div>
                    <div>
                        <p className="text-xs text-gray-500 mb-1">Ortalama Sepet</p>
                    ...
                    <div>
                        <p className="text-xs text-gray-500 mb-1">İşlem Durumu</p>
