...
interface BatchReportSheetProps {
    ...
    event: {
        batchId: string;
        platform?: string; // allow string to match parent component's platform type
    } | null;
}
...
const mockErrors: ErrorItem[] = [
    {
        id: 'e1',
        platform: 'google',
        errorType: 'GCLID Missing',
        errorCode: 'missing_gclid',
        count: 45
    },
    {
        id: 'e2',
        platform: 'meta',
        errorType: 'User Data Missing',
    ...
    },
    {
        id: 'e3',
        platform: 'tiktok',
        errorType: 'Conversion Time Format',
            ...
            <div className="fixed right-0 top-0 h-full w-[600px] max-w-[90vw] bg-white shadow-2xl z-50 flex flex-col animate-in slide-in-from-right duration-300">
                ...
                <div className="flex-1 overflow-y-auto px-6 py-5">
                    <p className="text-sm text-slate-500 mb-4">
                        We found {issueCount} items that failed to upload. Grouped by error type:
                    </p>
                            ...
                            >
                                ...
                                <div className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    {error.platform === 'google' ? (
                                        ...
                                        <SiMeta className="w-4 h-4 text-blue-600" />
                                    )}
                                </div>
