  ...
  return (
    <Tabs defaultValue="data-quality" className="w-full">
      <TabsList className="grid w-full grid-cols-3">
        ...
        <TabsTrigger value="store-status">Store Status</TabsTrigger>
      </TabsList>
      
      <TabsContent value="data-quality" className="mt-6">
        <div className="flex flex-col items-center text-center h-full justify-between p-6">
      ...
      <TabsContent value="store-status" className="mt-6">
        <div className="flex flex-col h-full p-6">
