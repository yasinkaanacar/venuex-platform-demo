...
import { Edit, Eye, MoreHorizontal, ChevronDown, Download, Facebook, Instagram, CheckCircle, AlertTriangle, Info, Calendar, TrendingUp } from "lucide-react";
...
export function LocationsTable({ onRowClick, onEdit, filters, onManageFields, onAddNewLocation, onUploadLocations, onFiltersChange }: LocationsTableProps) {
  ...
  return (
    <Card className="mx-6 mb-6">
      ...
      {/* Second Div - Business Profile Interactions */}
