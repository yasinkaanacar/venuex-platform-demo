...
export default function Header({ lastSync, title = "Dashboard" }: HeaderProps) {
  ...
  return (
    <header className="bg-card border-b border-border sticky top-0 z-50 shadow-sm h-20">
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center vx-surface-muted">
          ...
          <div className="flex items-center space-x-8">
            <div className="flex flex-col items-center">
              <div className="flex items-center">
                {/* Step 1 - Completed */}
                <Tooltip title="Business Profile" arrow componentsProps={{ tooltip: { sx: { fontSize: '14px' } } }}>
                ...
                {/* Step 2 - Completed */}
                <Tooltip title="Sales & Offline Conversion" arrow componentsProps={{ tooltip: { sx: { fontSize: '14px' } } }}>
                  <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center">
                    <Check className="w-4 h-4 text-white" />
                  </div>
                </Tooltip>
              ...
              <div className="text-xs text-gray-500 mt-2">VenueX Setup</div>
            </div>
