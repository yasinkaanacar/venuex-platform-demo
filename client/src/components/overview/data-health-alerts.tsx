...
{locationsPageMode ? (
                  /* Simplified flow for locations page: Locations → VenueX → Location Platforms */
                  <>
                    ...
                    <g>
                      {/* Locations to VenueX (Online - green line) */}
                    ...
                    <g>
                      ...
                      {/* VenueX to Location Platforms flow */}
