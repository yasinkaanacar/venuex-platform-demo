          ...
          <div className="relative bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 py-8 px-6">
            ...
            <div className="relative w-full h-[350px]">
              ...
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1000 400" preserveAspectRatio="xMidYMid meet">
                ...
                <g opacity="0.3">
                  <path d={context === 'locations' ? "M 264 200 L 460 200" : "M 280 285 L 350 285 Q 375 285 375 260 L 375 225 Q 375 205 395 205 L 460 205"} stroke="#9ca3af" strokeWidth="2" fill="none" strokeDasharray="5,5" />
                ...
                <g>
                  ...
                  <path d={context === 'locations' ? "M 264 200 L 460 200" : "M 280 285 L 350 285 Q 375 285 375 260 L 375 225 Q 375 205 395 205 L 460 205"} stroke="#10b981" strokeWidth="3" fill="none" markerEnd="url(#arrow-success)" opacity="0.8" />
                ...
                <g>
                  ...
                  <path d={context === 'locations' ? "M 264 200 L 460 200" : "M 280 285 L 350 285 Q 375 285 375 260 L 375 225 Q 375 205 395 205 L 460 205"} stroke="url(#flowActive)" strokeWidth="2" fill="none" opacity="0.9">
