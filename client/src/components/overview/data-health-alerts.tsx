            ...
            <div className="bg-muted/20 rounded-lg p-4">
              ...
              <div className="relative w-full h-20 flex items-center">
                <svg className="absolute inset-0 w-full h-full z-[1]">
                  ...
                  {/* VenueX to Platforms line - with gap */}
                  <line x1="52%" y1="50%" x2="92%" y2="50%" stroke="url(#greenDotted)" strokeWidth="2" />
                </svg>
            ...
            <div className="bg-muted/20 rounded-lg p-4">
              ...
              <div className="relative w-full h-20 flex items-center">
                <svg className="absolute inset-0 w-full h-full z-[1]">
                  ...
                  {/* VenueX to Platforms line - with gap */}
                  <line x1="52%" y1="50%" x2="92%" y2="50%" stroke="url(#redDotted)" strokeWidth="2" />
                </svg>
            ...
            <div className="bg-muted/20 rounded-lg p-4">
              ...
              <div className="relative w-full h-20 flex items-center">
                <svg className="absolute inset-0 w-full h-full z-[1]">
                  ...
                  {/* VenueX to Platforms line - with gap */}
                  <line x1="52%" y1="50%" x2="92%" y2="50%" stroke="url(#greenDotted2)" strokeWidth="2" />
                </svg>
