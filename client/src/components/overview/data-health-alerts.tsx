              ...
              <div className="space-y-6 relative z-10">
                  ...
                  <div className="relative w-full h-20 flex items-center">
                    ...
                    <div className="absolute left-[10%] top-1/2 transform -translate-y-1/2 z-10">
                      <div className="flex flex-col items-center text-center">
                        ...
                        <span className="text-xs text-muted-foreground text-center whitespace-nowrap">Inventory Systems</span>
                        <div className="flex items-center gap-1 mt-1">
                          <div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div>
                          <span className="text-xs text-green-600">Online</span>
                        </div>
                ...
                <div className="bg-muted/20 rounded-lg p-4">
                  ...
                  <div className="relative w-full h-20 flex items-center">
                    <svg className="absolute inset-0 w-full h-full z-[1]">
                      <defs>
                        <pattern id="purpleDotted" patternUnits="userSpaceOnUse" width="8" height="2">
                          <circle cx="4" cy="1" r="1" fill="#8b5cf6" />
                        </pattern>
                      </defs>
                      {/* Source to VenueX line - aligned with logo centers */}
                      <line x1="20%" y1="35%" x2="48%" y2="35%" stroke="url(#purpleDotted)" strokeWidth="2" />
                      {/* VenueX to Platforms line - aligned with logo centers */}
                      <line x1="52%" y1="50%" x2="75%" y2="50%" stroke="url(#purpleDotted)" strokeWidth="2" />
                    </svg>
                    ...
                    <div className="absolute left-[10%] top-1/2 transform -translate-y-1/2 z-10">
                      <div className="flex flex-col items-center text-center">
                        ...
                        <span className="text-xs text-muted-foreground text-center whitespace-nowrap">POS Systems</span>
                        <div className="flex items-center gap-1 mt-1">
                          <div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div>
                          <span className="text-xs text-green-600">Online</span>
                        </div>
                        <span className="text-xs text-muted-foreground">Updated 45s ago</span>
                      </div>
                    </div>
