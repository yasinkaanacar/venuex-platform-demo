              ...
              <div className="p-3 pb-0 flex justify-center bg-[#f9fafb] rounded-t-lg">
                <div className="flex items-center dark:bg-gray-800 p-1 rounded-lg border shadow-inner w-full bg-[#ffffff]">
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 2xl:px-3 py-2 rounded-md text-xs font-semibold transition-all duration-200 flex-1 justify-center ${offlineRoasPlatform === 'Google'
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 2xl:px-3 py-2 rounded-md text-xs font-semibold transition-all duration-200 flex-1 justify-center ${offlineRoasPlatform === 'Meta'
                        ? 'bg-white dark:bg-gray-700 text-foreground shadow-md border border-gray-200 dark:border-gray-600'
                        : 'text-gray-500 dark:text-gray-400 hover:text-foreground hover:bg-white/50 dark:hover:bg-gray-700/50'
                      }`}
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 2xl:px-3 py-2 rounded-md text-xs font-semibold transition-all duration-200 flex-1 justify-center ${offlineRoasPlatform === 'TikTok'
                        ? 'bg-white dark:bg-gray-700 text-foreground shadow-md border border-gray-200 dark:border-gray-600'
                        : 'text-gray-500 dark:text-gray-400 hover:text-foreground hover:bg-white/50 dark:hover:bg-gray-700/50'
                      }`}
              ...
              <div className="p-3 pb-0 flex justify-center bg-[#f9fafb] rounded-t-lg">
                <div className="flex items-center dark:bg-gray-800 p-1 rounded-lg border shadow-inner w-full bg-[#ffffff]">
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 2xl:px-3 py-2 rounded-md text-xs font-semibold transition-all duration-200 flex-1 justify-center ${locationEngagementsPlatform === 'Google'
                        ? 'bg-white dark:bg-gray-700 text-foreground shadow-md border border-gray-200 dark:border-gray-600'
                        : 'text-gray-500 dark:text-gray-400 hover:text-foreground hover:bg-white/50 dark:hover:bg-gray-700/50'
                      }`}
                    data-testid="tab-google"
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 2xl:px-3 py-2 rounded-md text-xs font-semibold transition-all duration-200 flex-1 justify-center ${locationEngagementsPlatform === 'Apple'
                        ? 'bg-white dark:bg-gray-700 text-foreground shadow-md border border-gray-200 dark:border-gray-600'
                        : 'text-gray-500 dark:text-gray-400 hover:text-foreground hover:bg-white/50 dark:hover:bg-gray-700/50'
                      }`}
              ...
              <div className="p-3 pb-0 flex justify-center bg-[#f9fafb] rounded-t-lg">
                <div className="flex items-center dark:bg-gray-800 p-1 rounded-lg border shadow-inner w-full bg-[#ffffff]">
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 2xl:px-4 py-2 rounded-md text-xs font-semibold transition-all duration-200 flex-1 justify-center ${localInventoryPlatform === 'Google'
                        ? 'bg-white dark:bg-gray-700 text-foreground shadow-md border border-gray-200 dark:border-gray-600'
                        : 'text-gray-500 dark:text-gray-400 hover:text-foreground hover:bg-white/50 dark:hover:bg-gray-700/50'
                      }`}
                    data-testid="tab-google"
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 2xl:px-4 py-2 rounded-md text-xs font-semibold transition-all duration-200 flex-1 justify-center ${localInventoryPlatform === 'Meta'
                        ? 'bg-white dark:bg-gray-700 text-foreground shadow-md border border-gray-200 dark:border-gray-600'
                        : 'text-gray-500 dark:text-gray-400 hover:text-foreground hover:bg-white/50 dark:hover:bg-gray-700/50'
                      }`}
                    data-testid="tab-meta"
              ...
              <div className="p-3 pb-0 flex justify-center bg-[#f9fafb] rounded-t-lg">
                <div className="flex items-center dark:bg-gray-800 p-1 rounded-lg border shadow-inner w-full bg-[#ffffff]">
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 2xl:px-4 py-2 rounded-md text-xs font-semibold transition-all duration-200 flex-1 justify-center ${averageRatingPlatform === 'Google'
                        ? 'bg-white dark:bg-gray-700 text-foreground shadow-md border border-gray-200 dark:border-gray-600'
                        : 'text-gray-500 dark:text-gray-400 hover:text-foreground hover:bg-white/50 dark:hover:bg-gray-700/50'
                      }`}
                    data-testid="tab-google"
