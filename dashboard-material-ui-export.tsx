...
const PlatformIcon = styled(Avatar)<{ platformColor: string }>(({ platformColor }) => ({
  width: 24,
  height: 24,
  fontSize: '12px',
  fontWeight: 700,
...
const SuggestionIcon = styled(Avatar)<{ iconType: string }>(({ iconType }) => ({
  ...
  height: 40,
  backgroundColor: 
    iconType === 'hours' ? '#16a34a' :
    iconType === 'description' ? '#9333ea' :
    iconType === 'location' ? '#2563eb' : '#f59e0b'
}));
...
const VenueXDashboard: React.FC = () => {
  ...
  const getSuggestionIcon = (iconType: string) => {
    switch (iconType) {
      ...
      case 'description': return <EmojiObjects />;
      case 'hours': return <Receipt />;
      default: return <Info />;
    }
  };
              ...
              <CardContent>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', color: 'success.main' }}>
                    {kpi.trendDirection === 'up' ? <TrendingUp fontSize="small" /> : <TrendingDown fontSize="small" />}
        ...
        <CardHeader
          title={
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                Overall Score: <Typography component="span" sx={{ color: 'success.main', fontWeight: 600 }}>97%</Typography>
              </Typography>
            </Box>
          }
          action={
        ...
        <CardContent>
              ...
              <Grid item xs={12} md={4} key={sectionIndex}>
                ...
                {section.items.map((item, itemIndex) => (
                  <Box key={itemIndex} sx={{ 
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      <QualityBar>
                        <Box className="fill" sx={{ width: `${item.percentage}%` }} />
                      </QualityBar>
                      <Typography variant="body2" sx={{ fontWeight: 500, minWidth: '32px' }}>
                        {item.percentage}%
                      </Typography>
                    </Box>
                  </Box>
          ...
          <Box sx={{ borderTop: 2, borderColor: 'divider', pt: 4, mt: 4 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
                    ...
                    <Box sx={{ flex: 1 }}>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                        ...
                        <Chip 
                          label={suggestion.impact.charAt(0).toUpperCase() + suggestion.impact.slice(1)}
            ...
            <Box sx={{ 
              ...
              <Typography variant="body2" color="text.secondary">
                3 suggestions shown • Potential impact: <Typography component="span" sx={{ fontWeight: 500 }}>+48.0% overall performance</Typography>
              </Typography>
