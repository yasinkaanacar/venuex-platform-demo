...
import {Iconify, fShortenNumber, useLocales, fPercentChangeCustom, fCapitalize} from "@libs/atomic";
import {Box, CircularProgress, Stack, Typography} from "@mui/material";
import {calculatePercentageChange} from "@libs/utils";
import {NormalizedAdMetricsResponse} from "@libs/interfaces";
import {TrendInfo} from "../../components/common";
...
export default function OfflineConversionFlowChart({
    ...
    return (
        ...
        >
            <Stack gap={0.5}>
                <Typography variant="vx_title_xsmall_regular" color="grey.600">
                    {t("common.cost")}
                </Typography>
                <Typography variant="vx_title_large_bold" color="primary.darker">
            ...
            >
                ...
                >
                    ...
                    <Box sx={{transform: "translateY(-28px)"}}>
                        <Typography variant="vx_title_small_medium" color="success.dark">
                            <span>%</span>
                            <Typography variant="vx_title_large_bold">100</Typography>
